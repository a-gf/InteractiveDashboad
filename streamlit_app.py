...
st.markdown("This application is a dashboard used to analize the sentiment of tweets 🤗")
st.sidebar.markdown("This application is a dashboard used to analize the sentiment of tweets 🤗")
...
choice = st.sidebar.multiselect('Pick airlines',('US Airways','United','American','Southwest','Delta','Virgin America'), key='multiselect')
...
if not st.sidebar.checkbox("Close", True, key="3"):
    ...
    # Pasar la figura explícitamente a st.pyplot()
    st.pyplot(fig)
